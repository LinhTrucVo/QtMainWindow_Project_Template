...
void Task_1_UI::fromThreadHandling(QString mess, QVariant data)
{
    if(mess == "show")
    {
        show();
...
void Task_1_UI::on_pushButton_clicked()
{
    emit toThread("mess_from_ui", "button_clicked");
}


void Task_1_UI::on_pushButton_2_clicked()
{
    emit toThread("1", "111");
}

void Task_1_UI::on_pushButton_3_clicked()
{
    emit toThread("2", "222");
}
